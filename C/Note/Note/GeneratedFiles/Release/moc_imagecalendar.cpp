...
void ImageCalendar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ImageCalendar *_t = static_cast<ImageCalendar *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject ImageCalendar::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ImageCalendar.data,
      qt_meta_data_ImageCalendar,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ImageCalendar::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ImageCalendar.stringdata0))
        return static_cast<void*>(const_cast< ImageCalendar*>(this));
